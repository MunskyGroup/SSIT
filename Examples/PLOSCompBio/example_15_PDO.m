...
STL1_4state_PDO = STL1_4state_STL1_4state_MH_it;
...
fimTotal = STL1_4state_PDO.evaluateExperiment(STL1_4state_fimResults,...
...
nCellsOpt = STL1_4state_PDO.optimizeCellCounts(STL1_4state_fimResults,...
                                        nTotal,'tr[1:15]');

nCellsOptAvail = min(nCellsOpt,STL1_4state_PDO.dataSet.nCells)
fimOpt = STL1_4state_PDO.evaluateExperiment(STL1_4state_fimResults,...
                                        nCellsOpt,diag(sig_log10.^2));
fimOptAvail = STL1_4state_PDO.evaluateExperiment(STL1_4state_fimResults,...
                                      nCellsOptAvail,diag(sig_log10.^2));
figOpt = figure;
STL1_4state_PDO.plotMHResults(STL1_4state_MHResults,...
                [fimOpt,STL1_4state_fimTotal],'log',[],figOpt,plotColors);
figOptAvail = figure;
STL1_4state_PDO.plotMHResults(STL1_4state_MHResults,...
       [fimOptAvail,STL1_4state_fimTotal],'log',[],figOptAvail,plotColors);
...
STL1_4state_PDO_intens.calibratePDO('data/filtered_data_2M_NaCl_Step.csv',...
...
fimPDO = STL1_4state_PDO.evaluateExperiment(fimsPDO,...
                                     nCellsOpt,diag(sig_log10.^2));

nCellsOptPDO = ...
    STL1_4state_PDO.optimizeCellCounts(fimsPDO,nTotal,'tr[1:15]');


figPDO = figure;
STL1_4state_PDO.plotMHResults(STL1_4state_MHResults,...
                    [fimPDO,STL1_4state_fimTotal,fimOpt],'log',[],figPDO);
...
STL1_4state_PDO_intens.plotMHResults(STL1_4state_MHResults,...
            [fimPDOintens,STL1_4state_fimTotal,fimOpt],'log',[],figintens);
