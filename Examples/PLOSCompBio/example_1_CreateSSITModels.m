...
% paper): (1-(exp(1)^(-r1*(t-to))))exp(1)^(-r2*(t-to))
STL1_4state.inputExpressions = {'Hog1','A*(((1-(exp(1)^(-r1*(t-to))))*exp(1)^(-r2*(t-to)))/(1+((1-(exp(1)^(-r1*(t-to))))*exp(1)^(-r2*(t-to)))/M))^n'};
