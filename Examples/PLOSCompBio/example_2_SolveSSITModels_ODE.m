...
%% 4-state STL1 Model:
    ...
    STL1_4state_ODE.plotODE(...
        STL1_4state_ODE.species{5}, STL1_4state_ODE.tSpan, ...
        {'linewidth',4}, Title='4-state STL1', TitleFontSize=24,...
        AxisLabelSize=18, TickLabelSize=18,...
    ...
    STL1_4state_ODE.plotODE(...
        STL1_4state_ODE.species(1:4), STL1_4state_ODE.tSpan, ...
        {'linewidth',4}, Title='4-state STL1 (zoomed)', TitleFontSize=24,...
        AxisLabelSize=18, TickLabelSize=18,...
