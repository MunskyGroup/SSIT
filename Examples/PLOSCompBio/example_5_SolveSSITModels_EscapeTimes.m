...
%% Model:
    ...
    Model_escape.makePlot(fspSoln_escape_1,'escapeTimes')
...
STL1_escape.makePlot(STL1_fspSoln_escape,'escapeTimes')
...
STL1_4state_escape.makePlot(STL1_4state_fspSoln_escape,'escapeTimes')
