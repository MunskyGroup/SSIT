...
% Run Metropolis-Hastings: 
[Model_MH_pars,~,Model_MHResults] = Model_MH.maximizeLikelihood(...
    [], MHOptions, 'MetropolisHastings');
...
% Plot results:
Model_MH.plotMHResults(Model_MHResults,[],'log',[])
...
STL1_FIMlog = STL1_MH_FIM.evaluateExperiment(STL1_fimResultsLog,STL1_MH_FIM.dataSet.nCells);
STL1_fimResults= STL1_MH_FIM.computeFIM(STL1_sensSoln.sens,'lin');
STL1_FIM = STL1_MH_FIM.evaluateExperiment(STL1_fimResults,STL1_MH_FIM.dataSet.nCells);
...
STL1_MH_FIM.makeMleFimPlot(exp(STL1_chainResults_FIM.mhSamples)',STL1_FIM{1},Q,0.95,1); hold on
...
subplot(1,3,3)
STL1_MH_FIM.makeMleFimPlot(STL1_chainResults_FIM.mhSamples',STL1_FIMlog{1},Q,0.95,1); hold on
