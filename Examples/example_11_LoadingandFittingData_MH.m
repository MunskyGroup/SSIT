%% SSIT/Examples/example_11_LoadingandFittingData_MH
...
% example_04_SolveSSITModels_FSP, data loaded in 
% example_09_LoadingandFittingData_DataLoading, and MLE computed in
