...
STL1_hybrid.plotFSP(STL1_hybrid_FSPsoln, STL1_hybrid.species(5),...
    'meansAndDevs', [], [], {'linewidth',4}, Colors=[0.23,0.67,0.2],...
    Title='4-state STL1 (hybrid)', TitleFontSize=26, YLim=[-10,50],...
    YLabel='Molecule Count',LegendFontSize=20,...
    LegendLocation='northeast', AxisLabelSize=20, TickLabelSize=20);
