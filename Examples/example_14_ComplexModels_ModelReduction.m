...
STL1_MR_setup.plotFSP(STL1_FSPsoln_expand,...
    STL1_MR_setup.species(5), 'meansAndDevs', [], [], {'linewidth',4},...
...
STL1_MR.plotFSP(STL1_FSPsoln_Red,...
    STL1_MR.species(5), 'meansAndDevs', [], [], {'linewidth',4},...
    Title='4-state STL1 (FSP reduced)', TitleFontSize=24,...
    AxisLabelSize=18, TickLabelSize=18, XLabel='Time',...
    YLabel='Molecule Count', LegendFontSize=15, LegendLocation='northeast');