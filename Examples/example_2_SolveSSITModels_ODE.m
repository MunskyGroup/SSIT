...
%% Model:
    ...
    Model_ODE.plotODE(speciesNames=Model_ODE.species,...
        ...
        makeMovie=true, videoFileName='Model_ODE.mp4')

    %% Make a movie of the ODE solution being plotted:
    % makeODEmovie(STL1_4state_ODE.Solutions, Model_ODE.species,...
    %              Model_ODE.tSpan, 'Model_ODE.mp4');
...
%% STL1 Model:
    ...
    %% Make a movie of the ODE solution being plotted:
    % makeODEmovie(STL1_4state_ODE.Solutions, STL1_ODE.species, STL1_ODE.tSpan, ...
    %             'STL1_ODE.mp4');
