...
%% 4-state STL1 model:
    ...
    STL1_4state.plotSSA(speciesIdx='all', numTraj=100,...
        ...
        XLabel='Time (min.)', YLabel='Molecule Count',...
        Colors=[0.23,0.67,0.20]);  
    ...
    STL1_4state.plotSSA(speciesIdx='all', numTraj=100,...
        ...
        XLabel='Time (min.)', YLabel='Molecule Count', makeMovie=false); 
...
save('ExampleSaveFiles/example_3_SolveSSITModels_SSA',saveNames{:})