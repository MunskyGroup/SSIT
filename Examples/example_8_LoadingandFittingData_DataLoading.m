...
Model_data.plotFits(plotType="all", lineProps={'linewidth',2},...
    Title='Bursting Gene', YLabel='Molecule Count',...
    LegendLocation='northeast', LegendFontSize=12);

STL1_data.plotFits(plotType="all", lineProps={'linewidth',2},...
    Title='STL1', YLabel='Molecule Count',...
    LegendLocation='northeast', LegendFontSize=12);

STL1_4state_data.plotFits(plotType="all", lineProps={'linewidth',2},...
