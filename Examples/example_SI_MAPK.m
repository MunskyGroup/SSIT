...
Toggle = Toggle.addReaction(struct('propensity',{'bxy*Px*(Px-1)*Gy_on'},...
        'stoichiometry',{{'Px',-2;'Gy_on',-1;'Gy_off',1}}));
Toggle = Toggle.addReaction(struct('propensity',{'bxy*Py*(Py-1)*Gx_on'},...
        'stoichiometry',{{'Py',-2;'Gx_on',-1;'Gx_off',1}}));
Toggle = Toggle.addReaction(struct('propensity',{'uxy*Gy_off'},...
        'stoichiometry',{{'Px',2;'Gy_on',1;'Gy_off',-1}}));
Toggle = Toggle.addReaction(struct('propensity',{'uxy*Gx_off'},...
    'stoichiometry',{{'Py',2;'Gx_on',1;'Gx_off',-1}}));
...
% R5: K + MEK -> K_MEK_Y
MAPK = MAPK.addReaction(struct('propensity',{'k1*K*MEK'},...
        'stoichiometry',{{'K',-1;'MEK',-1;'K_MEK_Y',1}}));

% R6: K_MEK_Y -> KpY + MEK, k2 = 0.06
MAPK = MAPK.addReaction(struct('propensity',{'k2*K_MEK_Y'},...
        'stoichiometry',{{'K_MEK_Y',-1;'KpY',1;'MEK',1}}));

% R7: KpY + MEK <=> KpY_MEK, k3 = 0.375, k-3 = 1.0
MAPK = MAPK.addReaction(struct('propensity',{'k3*KpY*MEK'},...
        'stoichiometry',{{'KpY',-1;'MEK',-1;'KpY_MEK',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'k_3*KpY_MEK'},...
        'stoichiometry',{{'KpY_MEK',-1;'KpY',1;'MEK',1}}));

% R8: KpY_MEK -> Kpp + MEK, k4 = 4.5
MAPK = MAPK.addReaction(struct('propensity',{'k4*KpY_MEK'},...
        'stoichiometry',{{'KpY_MEK',-1;'Kpp',1;'MEK',1}}));

% R9: K + MEK <=> K_MEK_T, k5 = 0.375, k-5 = 1.0
MAPK = MAPK.addReaction(struct('propensity',{'k5*K*MEK'},...
        'stoichiometry',{{'K',-1;'MEK',-1;'K_MEK_T',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'k_5*K_MEK_T'},...
        'stoichiometry',{{'K_MEK_T',-1;'K',1;'MEK',1}}));

% R10: K_MEK_T -> KpT + MEK, k6 = 0.06
MAPK = MAPK.addReaction(struct('propensity',{'k6*K_MEK_T'},...
        'stoichiometry',{{'K_MEK_T',-1;'KpT',1;'MEK',1}}));

% R11: KpT + MEK <=> KpT_MEK, k7 = 0.375, k-7 = 1.0
MAPK = MAPK.addReaction(struct('propensity',{'k7*KpT*MEK'},...
        'stoichiometry',{{'KpT',-1;'MEK',-1;'KpT_MEK',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'k_7*KpT_MEK'},...
        'stoichiometry',{{'KpT_MEK',-1;'KpT',1;'MEK',1}}));

% R12: KpT_MEK -> Kpp + MEK, k8 = 4.5
MAPK = MAPK.addReaction(struct('propensity',{'k8*KpT_MEK'},...
        'stoichiometry',{{'KpT_MEK',-1;'Kpp',1;'MEK',1}}));

% R13: Kpp + MKP3 <=> Kpp_MKP3, h1 = 0.015, h-1 = 1.0
MAPK = MAPK.addReaction(struct('propensity',{'h1*Kpp*MKP3'},...
        'stoichiometry',{{'Kpp',-1;'MKP3',-1;'Kpp_MKP3',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'h_1*Kpp_MKP3'},...
        'stoichiometry',{{'Kpp_MKP3',-1;'Kpp',1;'MKP3',1}}));

% R14: Kpp_MKP3 -> KpT_MKP3_Y, h2 = 0.032
MAPK = MAPK.addReaction(struct('propensity',{'h2*Kpp_MKP3'},...
        'stoichiometry',{{'Kpp_MKP3',-1;'KpT_MKP3_Y',1}}));

% R15: KpT_MKP3_Y <=> KpT + MKP3, h3 = 0.31, h-3 = 0.01
MAPK = MAPK.addReaction(struct('propensity',{'h3*KpT_MKP3_Y'},...
        'stoichiometry',{{'KpT_MKP3_Y',-1;'KpT',1;'MKP3',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'h_3*KpT*MKP3'},...
        'stoichiometry',{{'KpT',-1;'MKP3',-1;'KpT_MKP3_Y',1}}));

% R16: KpT + MKP3 <=> KpT_MKP3_T, h4 = 0.01, h-4 = 1.0
MAPK = MAPK.addReaction(struct('propensity',{'h4*KpT*MKP3'},...
        'stoichiometry',{{'KpT',-1;'MKP3',-1;'KpT_MKP3_T',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'h_4*KpT_MKP3_T'},...
        'stoichiometry',{{'KpT_MKP3_T',-1;'KpT',1;'MKP3',1}}));

% R17: KpT_MKP3_T -> K_MKP3_T, h5 = 0.5
MAPK = MAPK.addReaction(struct('propensity',{'h5*KpT_MKP3_T'},...
        'stoichiometry',{{'KpT_MKP3_T',-1;'K_MKP3_T',1}}));

% R18: K_MKP3_T <=> K + MKP3, h6 = 0.086, h-6 = 0.0011
MAPK = MAPK.addReaction(struct('propensity',{'h6*K_MKP3_T'},...
        'stoichiometry',{{'K_MKP3_T',-1;'K',1;'MKP3',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'h_6*K*MKP3'},...
        'stoichiometry',{{'K',-1;'MKP3',-1;'K_MKP3_T',1}}));

% R19: KpY + MKP3 <=> KpY_MKP3, h7 = 0.01, h-7 = 1.0
MAPK = MAPK.addReaction(struct('propensity',{'h7*KpY*MKP3'},...
        'stoichiometry',{{'KpY',-1;'MKP3',-1;'KpY_MKP3',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'h_7*KpY_MKP3'},...
        'stoichiometry',{{'KpY_MKP3',-1;'KpY',1;'MKP3',1}}));

% R20: KpY_MKP3 -> K_MKP3_Y, h8 = 0.47
MAPK = MAPK.addReaction(struct('propensity',{'h8*KpY_MKP3'},...
        'stoichiometry',{{'KpY_MKP3',-1;'K_MKP3_Y',1}}));

% R21: K_MKP3_Y <=> K + MKP3, h9 = 0.14, h-9 = 0.0018
MAPK = MAPK.addReaction(struct('propensity',{'h9*K_MKP3_Y'},...
        'stoichiometry',{{'K_MKP3_Y',-1;'K',1;'MKP3',1}}));
MAPK = MAPK.addReaction(struct('propensity',{'h_9*K*MKP3'},...
        'stoichiometry',{{'K',-1;'MKP3',-1;'K_MKP3_Y',1}}));
...
{'MKP3+Kpp_MKP3+KpT_MKP3_Y+KpT_MKP3_T+K_MKP3_T+KpY_MKP3+K_MKP3_Y';  % Sum of MKP3
    ...
    'K+K_MEK_Y+K_MEK_T+K_MKP3_T+K_MKP3_Y+KpY+KpY_MEK+KpY_MKP3+KpT+KpT_MEK+KpT_MKP3_Y+KpT_MKP3_T'}; 
    % Sum of all
