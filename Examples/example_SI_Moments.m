...
%% Plot results:
STL1_4state_mom.plotMoments(STL1_4state_mom.Solutions,...
    STL1_4state.species(5), "meansanddevs", STL1_4state_mom.tSpan, [],...
    {'linewidth',4}, Title='4-state STL1 (mRNA)', TitleFontSize=26,...
    LegendLocation='east', Colors=[0.23,0.67,0.20], LegendFontSize=20,...
    YLabel='Molecule Count', AxisLabelSize=20, TickLabelSize=20);

STL1_4state_mom.plotMoments(STL1_4state_mom.Solutions,...
    STL1_4state.species(1:4), "meansanddevs", STL1_4state_mom.tSpan, [],...
    {'linewidth',4}, Title='4-state STL1 (mRNA)', TitleFontSize=26,...
