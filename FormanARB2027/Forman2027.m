classdef Forman2027
    ...
    methods
        ...
        function obj = prepareFig4DEF(obj,opts)
            ...
            nMLE = opts.nMLE;
            obj.nCellsInExperiment = 0*obj.Model_BinomialPDO.tSpan;
            obj.nCellsInExperiment([1, 10, 31]) = 200;  
        ...
        function makeFigs4DEF(obj, f4d1, f4d2, f4e1, f4e2, f4f1, f4f2)
            ...
            Model_chg.plotFIMResults(FIM^(-1)/log(10)^2, 'log',...
                Model_chg.parameters(obj.freeParsFig4,1),...
                [Model_chg.parameters{obj.freeParsFig4,2}],...
                PlotEllipses=true, ...
                EllipseFigure=f4d1,...
                EllipseLevel=0.95,...
                Colors=struct('EllipseColors',[0,0,0],'CenterSquare',[0,0,0]),...
        ...
        function makeFig4GHI(obj, f4g, f4h, f4i)
