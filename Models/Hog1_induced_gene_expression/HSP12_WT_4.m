...
% It fills in the reactions table in the reactions tab.
        ...
        app.ReactionsTabOutputs.presetInputs = {'max(0,490*(1-(2.4*(9.3e9*(((1-exp(-(6.9e-5)*t))*exp(-(3.6e-3)*t))/(1+(((1-exp(-(6.9e-5)*t))*exp(-(3.6e-3)*t))/(6.4e-4))))^3.1))))'};
