function writeFunForMomentsODESymb(S,wString,xString,parString,momentOdeFileName)
%% function writeFunForMomentsODE(S,wString,x,momentOdeFileName)
...
G = matlabFunction(RHS,'Vars',{[v],[Parameter]},'File',momentOdeFileName); % save moment equation as a matlab function
