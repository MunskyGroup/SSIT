...
fprintf(fileID, "Nspec = " + Nspec + "; %% Number of species.\r\n");
fprintf(fileID, "Nt = " + Nt + "; %% Number of time points.\r\n");
...
for i=1:Nspec
    fprintf(fileID, "   x" + i + "_0_GPU = x0(" + i + ")*gpuArray.ones(1,N_run); %% Specific Initial Conditions.\r\n");
end
...
fprintf(fileID,txt3);
txt4 = "    X(:,:,i) = reshape(" + txt0.strip() + "],[Nt,Nspec])';\r\n";
fprintf(fileID,txt4);
fprintf(fileID,"  end\r\n");
