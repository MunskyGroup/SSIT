classdef FspMatrixTerm
    ...
    methods
        function obj = FspMatrixTerm(propensity, parameters, stateSet, numConstraints, varNames, modRedTransformMatrices, computeSens)
            arguments
                propensity
                parameters
                stateSet
            ...
            if ((~obj.isTimeDependent) || (obj.isFactorizable))
                ...
                if computeSens
                    ...
                    for ipar = 1:n_pars
                        obj.matrixSens{ipar} = ssit.FspMatrixTerm.GenerateMatrixTermTimeInvariant(propensity, parameters, stateSet, numConstraints, varNames, true, ipar); % The matrix data is generated only once
                    end
                end
